...
final class FeedUIIntegrationTests: XCTestCase {
	...
	private func makeSUT(file: StaticString = #filePath, line: UInt = #line) -> (sut: FeedViewController, loader: LoaderSpy, imageLoader: ImageLoaderSpy) {
		let loader = LoaderSpy()
		let imageLoader = ImageLoaderSpy()
		let sut = FeedUIComposer.feedComposedWith(
			feedLoader: loader.loadPublisher,
			imageLoader: imageLoader.loadImageDataPublisher)
